...
class BrokerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.unary_stream(
                ...
                request_serializer=broker__pb2.SubscriptionRequest.SerializeToString,
                response_deserializer=broker__pb2.Message.FromString,
                _registered_method=True)
        self.Publish = channel.unary_unary(
                '/broker.BrokerService/Publish',
...
def add_BrokerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=broker__pb2.SubscriptionRequest.FromString,
...
class BrokerService(object):
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/broker.BrokerService/Subscribe',
            broker__pb2.SubscriptionRequest.SerializeToString,
